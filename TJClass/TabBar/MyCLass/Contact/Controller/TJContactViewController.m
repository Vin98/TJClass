...
//#import "TJCustomNotificationDB.h"
//#import "TJNotificationCenter.h"
...
//#import "TJContactDataCell.h"
#import <NIMKit/NIMContactDataCell.h>
#import "NIMContactSelectViewController.h"
//#import "TJUserUtil.h"
//#import "TJBundleSetting.h"

@interface TJContactViewController ()<NIMUserManagerDelegate,
NIMSystemNotificationManagerDelegate,
TJContactUtilCellDelegate,
NIMContactDataCellDelegate,
NIMLoginManagerDelegate,
NIMEventSubscribeManagerDelegate> {
    UIRefreshControl *_refreshControl;
    TJGroupedContacts *_contacts;
}
...
@implementation TJContactViewController
...
- (void)prepareData{
    _contacts = [[TJGroupedContacts alloc] init];
    ...
    //构造显示的数据模型
    TJContactUtilItem *contactUtil = [[TJContactUtilItem alloc] init];
    NSMutableArray * members = [[NSMutableArray alloc] init];
    for (NSDictionary *item in utils) {
        TJContactUtilMember *utilItem = [[TJContactUtilMember alloc] init];
...
//        switch (index) {
//            case 0:
//                vc = [[TJContactAddFriendViewController alloc] initWithNibName:nil bundle:nil];
//                break;
//            case 1:{  //创建高级群
...
//            }
//            case 3:
//                vc = [[TJSearchTeamViewController alloc] initWithNibName:nil bundle:nil];
//                break;
//            default:
//                break;
//        }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    id<TJContactItem> contactItem = (id<TJContactItem>)[_contacts memberOfIndex:indexPath];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([cell isKindOfClass:[TJContactUtilCell class]]) {
        [(TJContactUtilCell *)cell refreshWithContactItem:contactItem];
        [(TJContactUtilCell *)cell setDelegate:self];
    }else{
...
//            if (index == 1) {
//                [SVProgressHUD show];
//                id<TJContactItem,TJGroupMemberProtocol> contactItem = (id<TJContactItem,TJGroupMemberProtocol>)[_contacts memberOfIndex:indexPath];
//                NSString *userId = [contactItem userId];
//                __weak typeof(self) wself = self;
//                [[NIMSDK sharedSDK].userManager deleteFriend:userId
//                                                 removeAlias:[[TJBundleSetting sharedConfig] autoRemoveAlias]
...
#pragma mark - TJContactUtilCellDelegate
