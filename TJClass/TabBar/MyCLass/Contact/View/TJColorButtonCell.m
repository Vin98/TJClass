...
@interface TJColorButtonCell()

@property (nonatomic,strong) NIMCommonTableRow *rowData;

@end

@implementation TJColorButtonCell

- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    self = [super initWithStyle:style reuseIdentifier:reuseIdentifier];
    if (self) {
        self.backgroundColor = [UIColor clearColor];
        _button = [[TJColorButton alloc] initWithFrame:CGRectZero];
...
- (void)refreshData:(NIMCommonTableRow *)rowData tableView:(UITableView *)tableView{
    ...
    TJColorButtonCellStyle style = [rowData.extraInfo integerValue];
...
@implementation TJColorButton : UIButton
...
- (void)setStyle:(TJColorButtonCellStyle)style{
    _style = style;
    [self reset];
}
...
//    switch (self.style) {
//        case TJColorButtonCellStyleRed:
//            imageNormalName = @"icon_cell_red_normal";
//            imageHighLightName  = @"icon_cell_red_pressed";
//            break;
//        case TJColorButtonCellStyleBlue:
