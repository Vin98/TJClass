...
#import "TJGroupedDataCollection.h"
...
@interface TJGroupedDataCollection () {
...
@implementation TJGroupedDataCollection
...
- (void)setMembers:(NSArray *)members
{
    ...
    for (id<TJGroupMemberProtocol>member in members) {
...
- (void)sortGroupMember
{
    [_groups enumerateObjectsUsingBlock:^(Pair *obj, NSUInteger idx, BOOL *stop) {
        ...
        [groupedMembers sortUsingComparator:^NSComparisonResult(id<TJGroupMemberProtocol> member1, id<TJGroupMemberProtocol> member2) {
